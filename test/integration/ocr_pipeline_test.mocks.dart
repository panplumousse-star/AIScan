...
class MockDocumentRepository extends _i1.Mock
  ...
  @override
  _i5.Future<Map<String, _i7.Uint8List>> getBatchDecryptedThumbnailBytes(
          List<_i3.Document>? documents) =>
      (super.noSuchMethod(
        Invocation.method(
          #getBatchDecryptedThumbnailBytes,
          [documents],
        ),
        returnValue: _i5.Future<Map<String, _i7.Uint8List>>.value(
            <String, _i7.Uint8List>{}),
      ) as _i5.Future<Map<String, _i7.Uint8List>>);
